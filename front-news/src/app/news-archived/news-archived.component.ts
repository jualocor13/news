...
@Component({
  selector: 'app-news-archived',
  templateUrl: './news-archived.component.html',
  styleUrls: ['./news-archived.component.css']
})
export class NewsArchivedComponent implements OnInit {/**
  * Submitted
  */
